function CityList(state) {
  with (document.getElementById("city")) {
    ...
    if (state == 0) {
      options[0] = new Option("لطفا اول استان را انتخاب نمایید", "");
    }

    if (state == 1) {
      options[0] = new Option("لطفا شهر را انتخاب نمایید", "");
      options[1] = new Option("احمدآبادمستوفی", "33131");
      ...
      options[6] = new Option("امیریه", "39861");
      options[7] = new Option("اندیشه", "31686");
      options[8] = new Option("اوشان", "33431");
      options[9] = new Option("آبسرد", "39761");
      options[10] = new Option("آبعلی", "39741");
      ...
      options[15] = new Option("پارچین", "33971");
      ...
      options[20] = new Option("پیشوا", "3381");
      options[21] = new Option("تجزیه مبادلات لشكر", "1012");
      options[22] = new Option("تهران", "1");
      options[23] = new Option("جاجرود", "16531");
      options[24] = new Option("چرمسازی سالاریه", "18361");
      ...
      options[54] = new Option("فیروزكوه", "3981");
      options[55] = new Option("قرچك", "18686");
      options[56] = new Option("قیام دشت", "18661");
      options[57] = new Option("كهریزك", "18161");
      options[58] = new Option("كیلان", "39751");
      options[59] = new Option("گلدسته", "33151");
      options[60] = new Option("گلستان (بهارستان)", "37571");
      options[61] = new Option("گیلاوند", "39711");
      options[62] = new Option("لواسان", "3341");
      options[63] = new Option("لوسان بزرگ", "33461");
      options[64] = new Option("مارلیك", "37541");
      options[65] = new Option("مروزبهرام", "33141");
      options[66] = new Option("ملارد", "31691");
      options[67] = new Option("منطقه 11 پستی تهران", "1011");
      options[68] = new Option("منطقه 13 پستی تهران", "1013");
      options[69] = new Option("منطقه 14 پستی تهران", "1014");
      options[70] = new Option("منطقه 15 پستی تهران", "1015");
      options[71] = new Option("منطقه 16 پستی تهران", "1016");
      options[72] = new Option("منطقه 17 پستی تهران  ", "1017");
      options[73] = new Option("منطقه 18 پستی تهران  ", "1018");
      options[74] = new Option("منطقه 19 پستی تهران  ", "1019");
      options[75] = new Option("نسیم شهر (بهارستان)", "37651");
      options[76] = new Option("نصیرآباد", "37551");
      options[77] = new Option("واوان", "33176");
      options[78] = new Option("وحیدیه", "33581");
      options[79] = new Option("ورامین", "3371");
    ...
    if (state == 2) {
      ...
      options[9] = new Option("آستانه اشرفیه", "4441");
      ...
      options[41] = new Option("سیاهكل", "4431");
      ...
      options[48] = new Option("قاسم آبادسفلی", "44831");
      options[49] = new Option("كپورچال", "43331");
      options[50] = new Option("كلاچای", "4491");
      options[51] = new Option("كوچصفهان", "43461");
      options[52] = new Option("كومله", "44761");
      options[53] = new Option("كیاشهر", "44471");
      options[54] = new Option("گشت", "43581");
      options[55] = new Option("لاهیجان", "441");
      ...
      options[60] = new Option("لوندویل", "43961");
      options[61] = new Option("لیسار", "43761");
      options[62] = new Option("ماسال", "4381");
      options[63] = new Option("ماسوله", "43571");
      options[64] = new Option("منجیل", "4451");
    ...
    if (state == 3) {
      ...
      options[21] = new Option("خداآفرین", "54683");
      ...
      options[28] = new Option("سیس", "53851");
      options[29] = new Option("شادبادمشایخ", "53671");
      options[30] = new Option("شبستر", "5381");
      options[31] = new Option("شربیان", "54751");
      options[32] = new Option("شرفخانه", "53891");
      options[33] = new Option("شهر جدید سهند", "5331");
      options[34] = new Option("صوفیان", "53861");
      options[35] = new Option("عجب شیر", "5541");
      options[36] = new Option("قره اغاج ـ چاراویماق", "5581");
      options[37] = new Option("قره بابا", "54941");
      options[38] = new Option("كردكندی", "54971");
      options[39] = new Option("كلیبر", "5461");
      ...
      options[47] = new Option("میانه", "531");
      options[48] = new Option("هادیشهر", "5431");
      options[49] = new Option("هریس", "5391");
    ...
    if (state == 4) {
      ...
      options[2] = new Option("امیدیه", "63731");
      options[3] = new Option("اندیمشك", "6481");
      options[4] = new Option("اهواز", "61");
      options[5] = new Option("ایذه", "6391");
      options[6] = new Option("آبادان", "631");
      options[7] = new Option("آغاجاری", "6371");
      options[8] = new Option("باغ ملك", "63951");
      options[9] = new Option("بندرامام خمینی", "63561");
      options[10] = new Option("بهبهان", "6361");
      options[11] = new Option("جایزان", "63881");
      options[12] = new Option("جنت مكان", "64541");
      options[13] = new Option("چمران ـ شهرك طالقانی", "63541");
      options[14] = new Option("حمیدیه", "63441");
      ...
      options[19] = new Option("رامشیر", "63871");
    ...
    if (state == 5) {
      ...
      options[14] = new Option("بنارویه", "74361");
      options[15] = new Option("بهمن", "73911");
      options[16] = new Option("بوانات", "73941");
      options[17] = new Option("بوانات(سوریان)", "73971");
      options[18] = new Option("بیرم", "74381");
      options[19] = new Option("جنت شهر(دهخیر)", "74891");
      options[20] = new Option("جهرم", "741");
      options[21] = new Option("جویم", "74351");
      options[22] = new Option("حاجی آباد ـ زرین دشت", "74861");
      ...
      options[28] = new Option("خیرآبادتوللی", "71451");
      options[29] = new Option("داراب", "7481");
      options[30] = new Option("داریان", "71461");
      options[31] = new Option("دهرم", "74781");
      options[32] = new Option("رونیز ", "74461");
      ...
      options[37] = new Option("سیدان", "73771");
      options[38] = new Option("ششده", "74651");
      options[39] = new Option("شهر جدید صدرا", "71991");
      options[40] = new Option("شیراز", "71");
      options[41] = new Option("صغاد", "73931");
      options[42] = new Option("صفاشهر ـ خرم بید", "73951");
      options[43] = new Option("طسوج", "71641");
      options[44] = new Option("علاءمرودشت", "74441");
      options[45] = new Option("فدامی", "74871");
      options[46] = new Option("فراشبند", "74771");
      options[47] = new Option("فسا", "7461");
      options[48] = new Option("فیروزآباد", "7471");
      options[49] = new Option("فیشور", "74311");
      options[50] = new Option("قادرآباد", "73751");
      options[51] = new Option("قائمیه", "7331");
      options[52] = new Option("قطب آباد", "74551");
      options[53] = new Option("قطرویه", "74981");
      options[54] = new Option("قیر و كارزین", "74761");
      options[55] = new Option("كازرون", "731");
      options[56] = new Option("كام فیروز", "73431");
      options[57] = new Option("كلانی", "73141");
      options[58] = new Option("كنارتخته", "73331");
      options[59] = new Option("كوار", "73461");
      options[60] = new Option("گراش", "7441");
      options[61] = new Option("گویم", "73491");
      ...
      options[67] = new Option("مصیري ـ رستم", "73571");
      options[68] = new Option("مظفری", "71661");
      options[69] = new Option("مهر", "74451");
      options[70] = new Option("میمند", "74741");
      options[71] = new Option("نورآباد ـ ممسنی", "7351");
      options[72] = new Option("نی ریز", "7491");
      options[73] = new Option("وراوی", "73171");
    }
    if (state == 6) {
      options[0] = new Option("لطفا شهر را انتخاب نمایید", "");
      options[1] = new Option("ابریشم", "81789");
      options[2] = new Option("ابوزیدآباد", "87481");
      options[3] = new Option("اردستان", "8381");
      options[4] = new Option("اریسمان", "87641");
      options[5] = new Option("اژیه", "83781");
      ...
      options[35] = new Option("داران ـ فریدن", "8561");
      options[36] = new Option("درچه پیاز", "8431");
      ...
      options[41] = new Option("دیزیچه", "84831");
      options[42] = new Option("رزوه", "85761");
      options[43] = new Option("رضوان شهر", "85331");
      options[44] = new Option("رهنان", "81879");
      options[45] = new Option("زاینده رود", "84931");
      options[46] = new Option("زرین شهر ـ لنجان", "8471");
      options[47] = new Option("زواره", "8441");
      options[48] = new Option("زیار", "81681");
      options[49] = new Option("زیبا شهر", "84841");
      options[50] = new Option("سپاهان شهر", "87992");
      options[51] = new Option("سده لنجان", "84741");
      options[52] = new Option("سمیرم", "8661");
      options[53] = new Option("شاهین شهر", "831");
      options[54] = new Option("شهرضا", "861");
      options[55] = new Option("شهرك صنعتی مورچ", "83331");
      options[56] = new Option("شهرك مجلسی", "8631");
      options[57] = new Option("شهرک صنعتی محمودآباد", "8161");
      options[58] = new Option("طالخونچه", "84981");
      options[59] = new Option("عسگران", "85351");
      options[60] = new Option("علویچه", "8551");
      options[61] = new Option("غرغن", "85631");
      options[62] = new Option("فرخی", "83641");
      options[63] = new Option("فریدون شهر", "8591");
      options[64] = new Option("فلاورجان", "8451");
      options[65] = new Option("فولادشهر", "8491");
      options[66] = new Option("فولادمباركه", "84881");
      options[67] = new Option("قهد ریجان", "8461");
      options[68] = new Option("كاشان", "871");
      options[69] = new Option("كلیشادوسودرجان", "84561");
      options[70] = new Option("كمشچه", "83591");
      options[71] = new Option("كوهپایه", "8371");
      options[72] = new Option("گز", "83441");
      options[73] = new Option("گلپایگان", "8771");
    ...
    if (state == 7) {
      ...
      options[3] = new Option("باجگیران", "94861");
      ...
      options[10] = new Option("بند قرای", "96791");
      options[11] = new Option("بیدخت", "96941");
      options[12] = new Option("تایباد", "9591");
      options[13] = new Option("تربت جام", "9571");
      options[14] = new Option("تربت حیدریه", "951");
      options[15] = new Option("جغتای", "9641");
      options[16] = new Option("جنگل", "95471");
      options[17] = new Option("چمن آباد", "95671");
      options[18] = new Option("چناران", "9361");
      options[19] = new Option("خلیل آباد", "96771");
      ...
      options[26] = new Option("رضویه", "91671");
      options[27] = new Option("ریوش(كوهسرخ)", "96741");
      ...
      options[32] = new Option("شاندیز", "93561");
      options[33] = new Option("صالح آباد", "9581");
      options[34] = new Option("طرقبه ـ بینالود", "9351");
      options[35] = new Option("طوس سفلی", "93571");
      options[36] = new Option("فریمان", "9391");
      options[37] = new Option("فیروزه ـ تخت جلگه", "9331");
      options[38] = new Option("فیض آباد ـ مه ولات", "9531");
      ...
      options[49] = new Option("مشهدریزه", "95961");
      options[50] = new Option("مصعبی", "97761");
      options[51] = new Option("نشتیفان", "95631");
      options[52] = new Option("نقاب ـ جوین", "96471");
      options[53] = new Option("نیشابور", "931");
      options[54] = new Option("نیل شهر", "95751");
    }
    if (state == 8) {
      options[0] = new Option("لطفا شهر را انتخاب نمایید", "");
      options[1] = new Option("َآوج", "3461");
      options[2] = new Option("ارداق", "34671");
      options[3] = new Option("اسفرورین", "34561");
      ...
      options[9] = new Option("بوئین زهرا", "3451");
      options[10] = new Option("بیدستان", "34151");
      options[11] = new Option("تاكستان", "3481");
      options[12] = new Option("حصارولیعصر", "34691");
      options[13] = new Option("خاكعلی", "34481");
      options[14] = new Option("خرم دشت", "34831");
      options[15] = new Option("دانسفهان", "34581");
      options[16] = new Option("سیردان", "34741");
      options[17] = new Option("شال", "34571");
      options[18] = new Option("شهر صنعتی البرز", "3410");
      options[19] = new Option("ضیاآباد", "34851");
      options[20] = new Option("قزوین", "341");
      options[21] = new Option("لیا", "34491");
      options[22] = new Option("محمدیه", "3491");
      options[23] = new Option("محمود آباد نمونه", "34131");
      options[24] = new Option("معلم كلایه", "34931");
      options[25] = new Option("نرجه", "34811");
    }
    if (state == 9) {
      options[0] = new Option("لطفا شهر را انتخاب نمایید", "");
      options[1] = new Option("ارادان", "35861");
      options[2] = new Option("امیریه", "3681");
      options[3] = new Option("ايوانكی", "3591");
      options[4] = new Option("بسطام", "3641");
      options[5] = new Option("بیارجمند", "3661");
      options[6] = new Option("خیرآباد", "35331");
      options[7] = new Option("دامغان", "3671");
      options[8] = new Option("درجزین", "35631");
      options[9] = new Option("سرخه", "3551");
      options[10] = new Option("سمنان", "351");
      options[11] = new Option("شاهرود", "361");
      options[12] = new Option("شهمیرزاد", "3571");
      options[13] = new Option("گرمسار", "3581");
      options[14] = new Option("مجن", "3651");
      options[15] = new Option("مهدی شهر", "3561");
      options[16] = new Option("میامی", "3631");
      options[17] = new Option("میغان", "36441");
    }
    if (state == 10) {
      options[0] = new Option("لطفا شهر را انتخاب نمایید", "");
    ...
    if (state == 11) {
      ...
      options[3] = new Option("آشتیان", "3961");
      options[4] = new Option("تفرش", "3951");
      options[5] = new Option("توره", "38661");
      options[6] = new Option("جاورسیان", "38451");
      options[7] = new Option("خسروبیك", "38541");
      options[8] = new Option("خشك رود", "37761");
      options[9] = new Option("خمین", "3881");
      options[10] = new Option("خنداب", "3841");
      options[11] = new Option("دلیجان", "3791");
      options[12] = new Option("ریحان علیا", "38941");
      options[13] = new Option("زاویه", "39441");
      ...
      options[18] = new Option("فرمهین", "39531");
      options[19] = new Option("كمیجان", "3851");
      options[20] = new Option("مامونیه ـ زرندیه", "3941");
      options[21] = new Option("محلات", "3781");
      options[22] = new Option("میلاجرد", "38551");
    ...
    if (state == 12) {
      ...
      options[3] = new Option("اسفجین", "45371");
      options[4] = new Option("پری", "45431");
      options[5] = new Option("حلب", "45971");
      options[6] = new Option("خرمدره", "4571");
      options[7] = new Option("دستجرده", "45941");
      options[8] = new Option("دندی", "45471");
      options[9] = new Option("زرین آباد ـ ايجرود", "4531");
      options[10] = new Option("زرین رود", "45881");
      options[11] = new Option("زنجان", "451");
      options[12] = new Option("سلطانیه", "4551");
      options[13] = new Option("صائین قلعه", "45741");
      options[14] = new Option("قیدار", "4581");
      options[15] = new Option("گرماب", "45871");
      options[16] = new Option("گیلوان", "45931");
      options[17] = new Option("ماهنشان", "4541");
      options[18] = new Option("همایون", "45331");
      options[19] = new Option("هیدج", "45731");
    }
    if (state == 13) {
      options[0] = new Option("لطفا شهر را انتخاب نمایید", "");
      options[1] = new Option("اسلام آباد", "48451");
      options[2] = new Option("امیركلا", "4731");
      options[3] = new Option("ایزدشهر", "46411");
      ...
      options[10] = new Option("بهنمیر", "47441");
      options[11] = new Option("پل سفید ـ سوادكوه", "4791");
      options[12] = new Option("تنكابن", "4681");
      options[13] = new Option("جویبار", "4771");
      ...
      options[31] = new Option("شیرگاه", "47871");
      options[32] = new Option("شیرود", "46861");
      options[33] = new Option("عباس آباد", "46741");
      options[34] = new Option("فریدون كنار", "4751");
      options[35] = new Option("قائم شهر", "4761");
      options[36] = new Option("كلارآباد", "46731");
      options[37] = new Option("كلاردشت", "46661");
      options[38] = new Option("كیا كلا", "47731");
      options[39] = new Option("كیاسر", "4831");
      ...
      options[45] = new Option("مرزی كلا", "47561");
    ...
    if (state == 14) {
      ...
      options[2] = new Option("اینچه برون", "49751");
      ...
      options[7] = new Option("جلین", "49351");
      options[8] = new Option("خان ببین", "49531");
      options[9] = new Option("رامیان", "4951");
      options[10] = new Option("سیمین شهر", "48971");
      options[11] = new Option("علی آباد", "4941");
      options[12] = new Option("فاضل آباد", "49431");
      options[13] = new Option("كردكوی", "4881");
      options[14] = new Option("كلاله", "4991");
      options[15] = new Option("گالیكش", "49831");
      options[16] = new Option("گرگان", "491");
      options[17] = new Option("گمیش تپه", "48961");
      options[18] = new Option("گنبدكاوس", "4971");
      options[19] = new Option("مراوه تپه", "48733");
      options[20] = new Option("مینودشت", "4981");
    }
    if (state == 15) {
      options[0] = new Option("لطفا شهر را انتخاب نمایید", "");
      options[1] = new Option("ابی بیگلو", "56331");
      options[2] = new Option("اردبیل", "561");
      options[3] = new Option("اصلاندوز", "56981");
      options[4] = new Option("بیله سوار", "5671");
      ...
      options[9] = new Option("سرعین", "56391");
      options[10] = new Option("شهرك شهید غفاری", "56971");
      options[11] = new Option("كلور", "56891");
      options[12] = new Option("كوارئیم", "56431");
      options[13] = new Option("گرمی", "5651");
      options[14] = new Option("گیوی ـ كوثر", "56851");
      options[15] = new Option("لاهرود", "56653");
      options[16] = new Option("مشگین شهر", "5661");
      options[17] = new Option("نمین", "5631");
      options[18] = new Option("نیر", "5641");
      options[19] = new Option("هشتجین", "56871");
    }
    if (state == 16) {
      options[0] = new Option("لطفا شهر را انتخاب نمایید", "");
      options[1] = new Option("ارومیه", "571");
      options[2] = new Option("اشنویه", "5771");
      options[3] = new Option("ایواوغلی", "5831");
      ...
      options[8] = new Option("پیرانشهر", "5781");
      options[9] = new Option("تازه شهر", "5891");
      options[10] = new Option("تكاب", "5991");
      options[11] = new Option("چهاربرج قدیم", "59771");
      options[12] = new Option("خوی", "581");
      options[13] = new Option("دیزج", "57451");
      options[14] = new Option("دیزجدیز", "5837");
      options[15] = new Option("ربط", "59691");
      options[16] = new Option("زیوه", "57461");
      options[17] = new Option("سردشت", "5961");
      options[18] = new Option("سلماس", "5881");
      options[19] = new Option("سیلوانا", "57411");
      options[20] = new Option("سیلوه", "573");
      options[21] = new Option("سیه چشمه ـ چالدران", "5871");
      options[22] = new Option("شاهین دژ", "5981");
      options[23] = new Option("شوط", "58751");
      options[24] = new Option("قره ضیاء الدین ـ چایپاره", "5851");
      options[25] = new Option("قوشچی", "5751");
      options[26] = new Option("كشاورز (اقبال)", "59731");
      options[27] = new Option("ماكو", "5861");
      options[28] = new Option("محمد یار", "57661");
      options[29] = new Option("محمودآباد", "59861");
      options[30] = new Option("مهاباد", "591");
      options[31] = new Option("میاندوآب", "5971");
      options[32] = new Option("میاوق", "57351");
      options[33] = new Option("میرآباد", "59671");
      options[34] = new Option("نقده", "5761");
      options[35] = new Option("نوشین شهر", "57381");
    }
    if (state == 17) {
      options[0] = new Option("لطفا شهر را انتخاب نمایید", "");
      options[1] = new Option("ازندریان", "65995");
      options[2] = new Option("اسدآباد", "6541");
      options[3] = new Option("اسلام آباد", "65791");
      options[4] = new Option("بهار", "6531");
      options[5] = new Option("پایگاه نوژه", "65992");
      options[6] = new Option("تویسركان", "6581");
      ...
      options[11] = new Option("شیرین سو", "65571");
      options[12] = new Option("صالح آباد", "65361");
      options[13] = new Option("فامنين", "6561");
      options[14] = new Option("قروه درجزین", "65691");
      options[15] = new Option("قهاوند", "65631");
      options[16] = new Option("كبودرآهنگ", "6551");
      options[17] = new Option("گیان", "65961");
      options[18] = new Option("لالجین", "65331");
      options[19] = new Option("ملایر", "6571");
    ...
    if (state == 21) {
      ...
      options[8] = new Option("بندردیر", "75541");
      options[9] = new Option("بندردیلم", "75361");
      options[10] = new Option("بندرریگ", "75331");
    ...
    if (state == 22) {
      ...
      options[40] = new Option("كیان شهر", "7771");
      options[41] = new Option("گلباف", "7641");
      options[42] = new Option("ماهان", "7631");
      options[43] = new Option("محمدآباد ـ ریگان", "7691");
      options[44] = new Option("محی آباد", "76891");
    ...
    if (state == 23) {
      options[0] = new Option("لطفا شهر را انتخاب نمایید", "");
      options[1] = new Option("ابوموسی", "79591");
      options[2] = new Option("ایسین", "79331");
      options[3] = new Option("بستك", "7961");
      options[4] = new Option("بندرخمیر", "7931");
      options[5] = new Option("بندرعباس", "791");
      options[6] = new Option("بندرلنگه", "7971");
      options[7] = new Option("بندزك كهنه", "79981");
      options[8] = new Option("پارسیان", "79771");
      options[9] = new Option("پدل", "79631");
      options[10] = new Option("پل شرقی", "79341");
      options[11] = new Option("تیاب", "79971");
      options[12] = new Option("جاسك", "79791");
      options[13] = new Option("جزیره سیری", "79581");
      options[14] = new Option("جزیره لاوان", "79781");
      options[15] = new Option("جزیره هنگام", "79571");
      options[16] = new Option("جزیرهلارك", "79561");
      ...
      options[21] = new Option("دشتی", "79761");
      options[22] = new Option("دهبارز ـ رودان", "7991");
      options[23] = new Option("رویدر", "79661");
      options[24] = new Option("زيارت علی", "79941");
      options[25] = new Option("سردشت ـ بشاگرد", "79881");
      options[26] = new Option("سندرك", "79841");
      options[27] = new Option("سیریك", "79461");
      options[28] = new Option("فارغان", "79371");
      options[29] = new Option("فین", "79351");
      options[30] = new Option("قشم", "7951");
      options[31] = new Option("كنگ", "79641");
      options[32] = new Option("كیش", "7941");
      options[33] = new Option("میناب", "7981");
    }
    if (state == 24) {
      options[0] = new Option("لطفا شهر را انتخاب نمایید", "");
      options[1] = new Option("اردل", "8881");
      options[2] = new Option("آلونی", "88941");
      options[3] = new Option("باباحیدر", "88631");
      options[4] = new Option("بروجن", "8871");
      options[5] = new Option("بلداجی", "88761");
      ...
      options[11] = new Option("دستنای", "88361");
      ...
      options[16] = new Option("شلمزار ـ كیار", "88371");
      ...
      options[25] = new Option("مال خلیفه", "88951");
      options[26] = new Option("ناغان", "88831");
      options[27] = new Option("هارونی", "8844");
    ...
    if (state == 25) {
      ...
      options[5] = new Option("بفروئیه", "89631");
      options[6] = new Option("بهاباد", "89761");
      options[7] = new Option("تفت", "8991");
      options[8] = new Option("حمیدیا", "89491");
      options[9] = new Option("زارچ", "89418");
      options[10] = new Option("شاهدیه", "89431");
      ...
      options[16] = new Option("مهریز", "8981");
      options[17] = new Option("میبد", "8961");
      options[18] = new Option("نیر", "89961");
      options[19] = new Option("هرات ـ خاتم", "89881");
      options[20] = new Option("یزد", "891");
    }
    if (state == 26) {
      options[0] = new Option("لطفا شهر را انتخاب نمایید", "");
      options[1] = new Option("اسپكه", "99431");
      options[2] = new Option("ایرانشهر", "991");
      ...
      options[22] = new Option("سوران ـ سیب سوران", "9961");
      options[23] = new Option("سیركان", "99571");
    ...
    if (state == 28) {
      ...
      options[4] = new Option("دهدشت ـ كهگیلویه", "7571");
      options[5] = new Option("دوگنبدان ـ گچساران", "7581");
      options[6] = new Option("دیشموك", "75771");
      options[7] = new Option("سپیدار", "75931");
      options[8] = new Option("سوق", "75731");
      options[9] = new Option("سی سخت ـ دنا", "75991");
      options[10] = new Option("قلعه رئیسي", "75781");
      options[11] = new Option("لنده", "75741");
      options[12] = new Option("لیكك", "75751");
      options[13] = new Option("مادوان", "75911");
      options[14] = new Option("یاسوج", "7591");
    }
    if (state == 29) {
      options[0] = new Option("لطفا شهر را انتخاب نمایید", "");
      options[1] = new Option("اسفراین", "9661");
      options[2] = new Option("ایور", "94331");
      ...
      options[9] = new Option("شیروان", "9461");
    ...
    if (state == 31) {
      ...
      options[4] = new Option("سیف آباد", "33611");
      options[5] = new Option("شهر جدید هشتگرد", "33618");
      ...
      options[13] = new Option("مشکین دشت", "31776");
...
function CityList2(state) {
  with (document.getElementById("city2")) {
    options.length = 0;
